...
{
    public partial class frmPesqInstalacao : Form
    {
        public int codigo = 0;

        public frmPesqInstalacao()
        {
            InitializeComponent();
        }
        ...
        private void txtPesquisar_TextChanged(object sender, EventArgs e)
        {
            ...
            if (dgvDados.Rows.Count == 0)
            {
                ...
                mensagem.Text = "Instalacao não encontrado, verifique o nome e tenta de novo";
            }
        }

        private void frmPesqInstalacao_Load(object sender, EventArgs e)
        {
            ...
            dgvDados.Columns[2].HeaderText = "Escalão";
            dgvDados.Columns[2].Width = 100;
            dgvDados.Columns[3].HeaderText = "Contador";
            dgvDados.Columns[3].Width = 200;
            dgvDados.Columns[4].HeaderText = "Local de Abastecimento";
